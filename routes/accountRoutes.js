...
// router.get('/users/send-verification-email', checkAuth, async (req, res) => {
...
//         res.render('vote', { username: req.user.username, verified: req.user.isVerified, emailsent: true });
//     }
// });
